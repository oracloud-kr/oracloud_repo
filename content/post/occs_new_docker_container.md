...
컨테이너 상세 정보 페이지에서 <그림 12>와 같이 컨테이너 상태를 출력하는 탭과 <그림 13>과 같이 컨테이너의 실행 YAML 설정을 확인할 수 있습니다. 이 탭에서 컨테이너에 이미지 정보, 포트 바인딩 정보와 환경 정보를 확인할 수있습니다. <그림 13>에서 현재 컨테이너는 호스트의 3000포트를 컨테이너의 80포트에 바인딩하는 설정을 확인할 수 있습니다.
