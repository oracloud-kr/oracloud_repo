...
하나의 컴퓨터에서 어려 개의 ssh 키를 사용하면, SSH 접속에 사용하는 ssh 명령이 복잡해지는 단점이 있습니다.
...
alias를 사용하면 명령을 쉽게 입력할 수 는 있지만 별도의 alias를 관리한다는 것이 부담스럽습니다.  
...
위 설정 파일은 2개의 아마존 서버와 github 및 bitbucket 서버 ssh 설정이 등록되어 있습니다.
